(() => {
  ...
  // ../../node_modules/@barchart/common-js/dist/cjs/lang/object.js
  ...
  // ../../node_modules/@barchart/common-js/dist/cjs/timing/Scheduler.js
  var require_Scheduler = __commonJS({
    "../../node_modules/@barchart/common-js/dist/cjs/timing/Scheduler.js"(exports, module) {
      ...
      var _timeoutBindings, _intervalBindings;
      var _Scheduler = class _Scheduler extends import_Disposable.default {
        constructor() {
          super();
          __privateAdd(this, _timeoutBindings);
          __privateAdd(this, _intervalBindings);
          __privateSet(this, _timeoutBindings, {});
          __privateSet(this, _intervalBindings, {});
        }
        /**
        ...
        async schedule(actionToSchedule, millisecondDelay, actionDescription) {
          ...
          const schedulePromise = promise.build((resolveCallback, rejectCallback) => {
            const wrappedAction = () => {
              const disposable = __privateGet(this, _timeoutBindings)[token];
              if (disposable) {
                disposable.dispose();
              }
              try {
            ...
            __privateGet(this, _timeoutBindings)[token] = import_Disposable.default.fromAction(() => {
              clearTimeout(token);
              delete __privateGet(this, _timeoutBindings)[token];
            });
          });
        ...
        repeat(actionToRepeat, millisecondInterval, actionDescription) {
          ...
          __privateGet(this, _intervalBindings)[token] = import_Disposable.default.fromAction(() => {
            clearInterval(token);
            delete __privateGet(this, _intervalBindings)[token];
          });
          return __privateGet(this, _intervalBindings)[token];
        }
        /**
         ...
         */
        _onDispose() {
          object.keys(__privateGet(this, _timeoutBindings)).forEach((key) => {
            __privateGet(this, _timeoutBindings)[key].dispose();
          });
          object.keys(__privateGet(this, _intervalBindings)).forEach((key) => {
            __privateGet(this, _intervalBindings)[key].dispose();
          });
          __privateSet(this, _timeoutBindings, null);
          __privateSet(this, _intervalBindings, null);
        }
        /**
         * @public
         * @static
      ...
      _timeoutBindings = new WeakMap();
      _intervalBindings = new WeakMap();
  ...
  // ../common-js/lib/data/serialization/EventSchema.js
  var require_EventSchema = __commonJS({
    "../common-js/lib/data/serialization/EventSchema.js"(exports, module) {
      var assert = require_assert();
      ...
      module.exports = (() => {
        ...
        const complete = new EventSchema(
          SchemaBuilder.withName("complete").withField("customer", DataType.forEnum(CustomerType, "CustomerType")).withField("product", DataType.forEnum(ProductType, "ProductType")).withField("type", DataType.forEnum(EventType, "EventType")).withField("version", DataType.STRING, true).withField("timestamp", DataType.TIMESTAMP).withField("batch", DataType.STRING).withField("sequence", DataType.NUMBER).withField("context", DataType.ARRAY).schema
        );
        const client = new EventSchema(
          SchemaBuilder.withName("client").withField("customer", DataType.forEnum(CustomerType, "CustomerType")).withField("product", DataType.forEnum(ProductType, "ProductType")).withField("type", DataType.forEnum(EventType, "EventType")).withField("version", DataType.STRING, true).withField("timestamp", DataType.TIMESTAMP).withField("context", DataType.ARRAY).schema
        );
        return EventSchema;
      })();
    }
  ...
  // lib/gateway/EventGateway.js
  var require_EventGateway = __commonJS({
    "lib/gateway/EventGateway.js"(exports, module) {
      var assert = require_assert();
      ...
      var EventSchema = require_EventSchema();
  ...
  // lib/engine/EventBatcher.js
  var require_EventBatcher = __commonJS({
    "lib/engine/EventBatcher.js"(exports, module) {
      var assert = require_assert();
      var is = require_is();
      var Scheduler = require_Scheduler();
      var EventGateway = require_EventGateway();
      module.exports = (() => {
        "use strict";
        class EventBatcher {
        ...
        async function scheduleBuffer() {
          ...
          if (this._buffer.length === 0) {
            this._scheduler.schedule(scheduleBuffer.bind(this), 5e3, "scheduleBuffer");
            return;
          }
          const batch = this._buffer;
          this._buffer = [];
  ...
  // example/browser/js/startup.event.vue.js
  var require_startup_event_vue = __commonJS({
    "example/browser/js/startup.event.vue.js"(exports, module) {
      var EventBatcher = require_EventBatcher();
      var EventGateway = require_EventGateway();
      var CustomerType = require_CustomerType();
      var ProductType = require_ProductType();
      var EventType = require_EventType();
